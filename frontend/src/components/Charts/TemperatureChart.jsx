        ...
        <Box sx={{ width: '100%', height }}>
          <ResponsiveContainer width='100%' height='100%'>
            ...
            >
              ...
              <ReferenceArea y1={clamp(yMin)} y2={clamp(18)} fill='#90caf9' fillOpacity={0.3} />
              <ReferenceArea y1={clamp(18)} y2={clamp(22)} fill='#c3f8d3' fillOpacity={0.3} />
              <ReferenceArea y1={clamp(22)} y2={clamp(26)} fill='#fcd4a5' fillOpacity={0.3} />
              <ReferenceArea y1={clamp(26)} y2={clamp(yMax)} fill='#f5b7a8' fillOpacity={0.3} />
              {stats && (
                <ReferenceLine
                  y={avgTemp}
                  stroke='#ff9800'
